...
namespace BinaryData
{
    ...
    extern const char*   JuliaIconActive_png;
    const int            JuliaIconActive_pngSize = 2067;

    extern const char*   JuliaIconInactive_png;
    const int            JuliaIconInactive_pngSize = 2201;
